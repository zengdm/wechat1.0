  ...
  onShareAppMessage: function (options) {
    ...
    if (that.data.args.feedid) {
      ...
      return {
        ...
        path: '/pages/info_detail/info_detail?feedid=' + that.data.args.feedid,
      ...
      return {
        title: that.data.detailData.title,
        path: '/pages/info_detail/info_detail?platid=' + that.data.myData.platid + '&sourceid=' + that.data.myData.sourceid,
        success: function (res) {
          console.log('分享成功');
        },
        fail: function (res) {
